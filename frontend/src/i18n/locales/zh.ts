export default {
  ...
  keys: {
    ...
    endpoints: {
      title: 'API 端点',
      openaiModels: 'OpenAI 系列模型',
      openaiModelsDescription: 'OpenAI 系列模型的 baseURL，需带 /v1 后缀。',
      anthropicModels: 'Anthropic 系列模型',
      anthropicModelsDescription: 'Anthropic 系列模型的 baseURL，不带 /v1 后缀。',
      openaiImages: 'OpenAI 图片',
      openaiImagesDescription: 'OpenAI 图片生成的 baseURL，需带 /v1 后缀。',
      default: '默认',
      copied: '已复制',
      copiedHint: '已复制到剪贴板',
  ...
  redeem: {
    ...
    repeatRedeemDialogTitle: '你已经兑换过这个福利码',
    repeatRedeemDialogSubtitle: '这次不能重复领取，但仍可查看手气榜',
    repeatRedeemLeaderboardBody: '这个福利码你已经兑换过了。如果它绑定了红包池和排行榜，你仍然可以查看当前的手气榜。',
    fixedAmount: '固定额度',
    luckyAmount: '手气红包',
    totalAmount: '总到账',
  ...
  profile: {
    ...
    concurrencyInviteHint: '点开邀请返利部分，可以增加自己的并发！',
    memberSince: '注册时间',
    administrator: '管理员',
    user: '用户',
    username: '用户名',
  ...
  userSubscriptions: {
    ...
    weekly: '每周',
    monthly: '每月',
    last7DaysUsage: '过去7天用量',
    last30DaysUsage: '过去30天用量',
    daysRemaining: '剩余 {days} 天',
    expiresOn: '{date} 到期',
    resetIn: '{time} 后重置',
