export default {
  ...
  keys: {
    ...
    dynamicBudgetDialogTitle: '设置预算倍率',
    dynamicBudgetDialogDescription: '切换到动态倍率分组 "{group}" 前，请确认此密钥的预算倍率。',
    dynamicBudgetDialogHint: '默认使用该分组的预算倍率 {default}x，可按需调整。',
    usage: '用量',
    today: '今日',
    total: '近30天',
    quota: '额度',
  ...
  admin: {
    ...
    subscriptionProducts: {
      ...
      emptyTitle: '暂无产品订阅',
      emptyDescription: '创建产品后，可让多个分组共享同一份额度。',
      loadError: '加载产品失败',
      updated: '产品已更新',
      created: '产品已创建',
      saveError: '保存产品失败',
  ...
  modelHub: {
    eyebrow: '按分组查看模型',
    title: '模型广场',
    description: '查看可用分组、支持模型和实际计费价格',
    searchLabel: '搜索',
    ...
    allGroups: '全部分组',
    groupsLabel: '可用分组',
    uniqueModelsLabel: '唯一模型',
    visibleModelsLabel: '当前显示',
    platformsLabel: '平台',
    sourceDefault: '平台默认',
    ...
    dynamicShort: '动态',
    budgetShort: '预算',
    accountRateRangeShort: '账号倍率',
    budgetReferenceShort: '预算参考',
    budgetMatchedRateShort: '预算内优先',
    noBudgetMatchedRate: '暂无',
    rateShort: '倍率',
    inputPriceShort: '输入',
    outputPriceShort: '输出',
    imageOutputPriceShort: '图片输出',
    ...
    copyGroup: '复制分组模型',
    copiedModel: '模型名已复制',
    copiedGroup: '分组模型列表已复制',
    copiedVisible: '当前结果已复制',
    modelCount: '{count} 个模型',
    clearFilters: '清除筛选',
    emptyTitle: '暂无模型',
    emptyDescription: '没有分组或模型匹配当前筛选',
    noModelsInGroup: '暂无模型',
    loadFailedTitle: '模型列表加载失败',
    loadFailedDescription: '请刷新后重试',
  },
  ...
  payment: {
    ...
    admin: {
      ...
      selectSubscriptionProduct: '选择订阅产品',
      noSubscriptionProduct: '不绑定产品（按分组兼容解析）',
      subscriptionProductHint: '同一个分组可被多个产品共享；售卖套餐建议明确绑定产品，避免履约时按分组猜错产品。',
      subscriptionProductsLoadError: '加载订阅产品失败',
      features: '功能特性',
      featuresHint: '每行一个特性',
