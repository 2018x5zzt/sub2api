export default {
  ...
  keys: {
    ...
    budgetMultiplierHint: 'Required for dynamic billing groups. Range: {min}x - {max}x. This group defaults to {default}x.',
    dynamicBudgetDialogTitle: 'Set budget multiplier',
    dynamicBudgetDialogDescription: 'Before switching to dynamic billing group "{group}", confirm this key\'s budget multiplier.',
    dynamicBudgetDialogHint: 'Defaults to this group\'s budget multiplier ({default}x). You can adjust it before saving.',
    usage: 'Usage',
    today: 'Today',
    total: 'Last 30d',
    quota: 'Quota',
  ...
  admin: {
    ...
    redeem: {
      ...
      selectProduct: 'Subscription Product',
      selectProductPlaceholder: 'Choose a subscription product',
      productRequired: 'Please select a subscription product for subscription codes',
      validityDays: 'Validity Days',
    ...
    ops: {
      ...
      runtime: {
        ...
        metricThresholdsHint: 'Optional thresholds for alert evaluation. Leave empty to use defaults.',
        slaMinPercent: 'SLA Minimum (%)',
        slaMinPercentHint: 'Trigger when availability drops below this percentage.',
        ttftP99MaxMs: 'TTFT P99 Maximum (ms)',
        ttftP99MaxMsHint: 'Trigger when P99 time to first token exceeds this value.',
        requestErrorRateMaxPercent: 'Request Error Rate Maximum (%)',
        requestErrorRateMaxPercentHint: 'Trigger when overall request error rate exceeds this percentage.',
        upstreamErrorRateMaxPercent: 'Upstream Error Rate Maximum (%)',
        upstreamErrorRateMaxPercentHint: 'Trigger when upstream error rate exceeds this percentage.',
        silencing: {
  ...
  modelHub: {
    ...
    title: 'Model Hub',
    description: 'Browse available groups, supported models, and effective pricing',
    searchLabel: 'Search',
    ...
    budgetShort: 'Budget',
    accountRateRangeShort: 'Account rates',
    budgetReferenceShort: 'Budget reference',
    budgetMatchedRateShort: 'Budget priority',
    noBudgetMatchedRate: 'None',
    rateShort: 'Rate',
    inputPriceShort: 'Input',
    outputPriceShort: 'Output',
    imageOutputPriceShort: 'Image output',
    ...
    noModelsInGroup: 'No models configured',
    loadFailedTitle: 'Failed to load model list',
    loadFailedDescription: 'Refresh and try again',
  },
  ...
  payment: {
    ...
    admin: {
      ...
      selectSubscriptionProduct: 'Select a subscription product',
      noSubscriptionProduct: 'No product binding (legacy group lookup)',
      subscriptionProductHint: 'A group can be shared by multiple products. Bind each sold plan to a product so fulfillment does not guess by group.',
      subscriptionProductsLoadError: 'Failed to load subscription products',
      features: 'Features',
