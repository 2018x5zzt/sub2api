export default {
  ...
  auth: {
    ...
    invitationCodePlaceholder: 'Enter invitation code (case-sensitive)',
    invitationCodeRequired: 'Invitation code is required',
    invitationCodeValid: 'Invitation code is valid',
    invitationCodeInvalid: 'Invalid, used, or wrong-case invitation code',
    ...
    invitationCodeInvalidCannotRegister: 'Invalid or wrong-case invitation code. Please check and try again',
  ...
  keys: {
    ...
    endpoints: {
      ...
      openaiModelsDescription: 'BaseURL for OpenAI models. Include the /v1 suffix.',
      anthropicModels: 'Anthropic models',
      anthropicModelsDescription: 'BaseURL for Anthropic models. Do not include the /v1 suffix.',
      openaiImages: 'OpenAI Images',
      openaiImagesDescription: 'BaseURL for OpenAI image generation. Include the /v1 suffix.',
      default: 'Default',
      copied: 'Copied',
    ...
    groupImmutableHint: 'The group cannot be changed after a key is created. Create a new key to switch groups.',
    statusLabel: 'Status',
    ...
    budgetMultiplierLabel: 'Budget Multiplier',
    budgetMultiplierHint: 'The system tries to keep the rolling 7-day standard-cost-weighted average within this budget. Requests may fail when lower-multiplier pools are unavailable.',
    budgetMultiplierRequired: 'Please enter a budget multiplier',
    budgetMultiplierRange: 'Budget multiplier must be between 3 and 50',
    usage: 'Usage',
    today: 'Today',
    total: 'Last 30d',
    quota: 'Quota',
  ...
  redeem: {
    ...
    benefitDialogTitle: 'Benefit Claimed',
    benefitDialogSubtitle: 'A note prepared for you',
    repeatRedeemDialogTitle: 'This benefit code has already been redeemed',
    repeatRedeemDialogSubtitle: 'You cannot claim it again, but you can still view the leaderboard',
    repeatRedeemLeaderboardBody: 'You have already redeemed this benefit code. If it is tied to a red packet pool and leaderboard, you can still view the current lucky leaderboard.',
    fixedAmount: 'Fixed amount',
    luckyAmount: 'Lucky bonus',
    totalAmount: 'Total',
    viewLuckyLeaderboard: 'View Lucky Leaderboard',
    luckyLeaderboardTitle: 'Lucky Leaderboard',
    luckyLeaderboardSummary: 'Redeemers are ranked by random bonus amount from highest to lowest.',
    randomPoolAmount: 'Random pool',
    remainingRandomPoolAmount: 'Remaining pool',
    leaderboardClaimProgress: 'Claimed {used} / {total}',
    yourLuckyRank: 'You are currently ranked #{rank}, random bonus {amount}, total {total}',
    you: 'You',
    usernameRequiredTitle: 'Set a Username First',
    usernameRequiredSubtitle: 'A username is required before joining the red packet leaderboard',
    usernameRequiredBody: 'Your account does not have a username yet. Please set one in Profile before claiming this red packet so the leaderboard can display you properly.',
    goSetUsername: 'Set Username'
  },
  ...
  profile: {
    ...
    concurrencyInviteHint: 'Open Invite Rebate to increase your own concurrency!',
  ...
  admin: {
    ...
    groups: {
      ...
      pricingMode: {
        label: 'Pricing Mode',
        hint: 'Fixed pricing uses the rate multiplier. Dynamic pricing routes across multiplier pools and controls cost with a budget multiplier.',
        fixed: 'Fixed Pricing',
        dynamic: 'Dynamic Pricing',
        dynamicValue: 'Budget {value}x',
        defaultBudgetMultiplier: 'Default Budget Multiplier',
        defaultBudgetHint: 'This value is prefilled when creating new keys. Decimals are allowed. Recommended range: 3.0 to 50.0.',
        defaultBudgetRange: 'Default budget multiplier must be between 3 and 50'
      },
    ...
    accounts: {
      ...
      groupBindingMultiplierShort: 'Bind',
      groupBindingMultiplierValue: 'Binding multiplier {rate}x',
      platforms: {
        anthropic: 'Anthropic',
        claude: 'Claude',
        openai: 'OpenAI',
      ...
      appendApiPath: 'Auto-append platform path',
      appendApiPathHint:
        'When enabled, Sub2API appends /v1/messages, /v1/responses, or Gemini model paths automatically. Disable it to use Base URL as a fixed endpoint directly and also attach Authorization: Bearer for AI Gateway style endpoints.',
    ...
    benefit: {
      ...
      description: 'Create and manage benefit codes for existing users',
      createCode: 'Create Benefit Code',
      editCode: 'Edit Benefit Code',
      deleteCode: 'Delete Benefit Code',
      searchCodes: 'Search benefit codes...',
      allStatus: 'All Status',
      columns: {
        code: 'Benefit Code',
        bonusAmount: 'Bonus Amount',
        maxUses: 'Max Redeemers',
        usedCount: 'Redeemed',
        usage: 'Usage',
        status: 'Status',
        expiresAt: 'Expires At',
      ...
      codePlaceholder: 'Enter a benefit code or leave blank',
      bonusAmount: 'Bonus Amount ($)',
      randomPoolAmount: 'Random Pool ($)',
      leaderboardEnabled: 'Enable Lucky Leaderboard',
      fixedAmount: 'Fixed amount',
      ...
      successMessagePlaceholder: 'For example: Thanks for your support. Enjoy the credit.',
      notes: 'Internal Notes',
      notesPlaceholder: 'Optional admin-only notes',
      status: 'Status',
      neverExpires: 'Never Expires',
      statusActive: 'Active',
      statusDisabled: 'Disabled',
      statusExpired: 'Expired',
      statusMaxUsed: 'Fully Redeemed',
      usageRecords: 'Redeem Records',
      viewUsages: 'View Redeem Records',
      noUsages: 'No redeem records yet',
      userPrefix: 'User #{id}',
      copied: 'Copied!',
      noCodesYet: 'No benefit codes yet',
      createFirstCode: 'Create your first benefit code to distribute bonus balance to existing users.',
      codeCreated: 'Benefit code created successfully',
      codeUpdated: 'Benefit code updated successfully',
      codeDeleted: 'Benefit code deleted successfully',
      deleteCodeConfirm: 'Are you sure you want to delete this benefit code? This action cannot be undone.',
      copyRegisterLink: 'Copy Register Link',
      registerLinkCopied: 'Register link copied to clipboard',
      failedToLoad: 'Failed to load benefit codes',
      failedToCreate: 'Failed to create benefit code',
      failedToUpdate: 'Failed to update benefit code',
      failedToDelete: 'Failed to delete benefit code',
      failedToLoadUsages: 'Failed to load redeem records'
    },
    ...
    settings: {
      ...
      affiliate: {
        title: 'Affiliate Rebates',
        description:
          'Users share invite codes to bind referral relationships. When invitees recharge, inviters earn rebate quota.',
        enabled: 'Enable Affiliate Rebates',
        enabledHint:
          'When disabled, the user entry is hidden and new recharges no longer accrue rebates. Registration never requires an invite code; codes only bind referral relationships.',
        rebateRate: 'Global Rebate Rate',
        rebateRateHint:
          'Default percentage returned to the inviter after recharge (0-100%, for example 10 means 10%).',
        freezeHours: 'Rebate Freeze Hours',
        freezeHoursDesc: 'New rebate quota cannot be transferred during the freeze window. 0 = no freeze.',
        durationDays: 'Rebate Duration Days',
	        durationDaysDesc: 'How many days after signup invitee recharges qualify. 0 = forever.',
	        perInviteeCap: 'Per-Invitee Rebate Cap',
	        perInviteeCapDesc: 'Maximum total rebate generated by each invitee. 0 = no cap.',
	        loadFailed: 'Failed to load affiliate settings',
	        tiers: {
	          title: 'Tiered Rebate Rules',
	          description:
	            'Automatically raise the rebate rate by the inviter’s effective invitee count. Custom user rates override tier rules.',
	          addButton: 'Add Tier',
	          empty: 'No tier rules configured; the global rebate rate will be used.',
	          minEffectiveInvitees: 'Minimum Effective Invitees',
	          rebateRate: 'Rebate Rate'
	        },
	        customUsers: {
          title: 'Custom User Settings',
          description: 'Set exclusive invite codes or rebate rates for selected users.',
          addButton: 'Add Custom User',
          searchPlaceholder: 'Search email or username',
          batchButton: 'Batch Set Rate ({count} selected)',
          empty: 'No custom affiliate users',
          customBadge: 'Custom',
          useGlobal: 'Use global',
          resetMessage:
            'Reset all custom settings for {email}?\nThe exclusive rate will be cleared and the invite code will be regenerated.',
        ...
        modal: {
          ...
          userLabel: 'User',
          userPlaceholder: 'Search email or username',
          changeUser: 'Change user',
          codeLabel: 'Exclusive Invite Code (optional)',
          codePlaceholder: 'e.g. VIP2026',
          codeHint:
            '4-32 chars. Uppercase letters, numbers, underscores, and hyphens only. Input is uppercased automatically.',
          rateLabel: 'Exclusive Rebate Rate (optional)',
          ratePlaceholder: 'e.g. 30',
          rateHint: '0-100%. In edit mode, leaving it empty clears the custom rate and uses global.',
          errorBadRate: 'Enter a rate between 0 and 100',
          errorEmpty: 'Enter at least one field: exclusive invite code or rebate rate'
        },
        batchModal: {
          title: 'Batch Set Custom Rate ({count} users)',
          hint: 'Apply one exclusive rebate rate to selected users.',
          placeholder: 'e.g. 30',
          clearHint: 'Submitting empty clears the selected users custom rates.'
        }
      },
