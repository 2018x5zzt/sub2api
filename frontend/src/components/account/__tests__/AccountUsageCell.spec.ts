...
describe('AccountUsageCell', () => {
  ...
  it('Antigravity Claude 用量会聚合 Sonnet 4.6 thinking 模型', async () => {
    getUsage.mockResolvedValue({
      antigravity_quota: {
        'claude-sonnet-4-6-thinking': {
          utilization: 63,
          reset_time: '2026-03-01T08:00:00Z'
        }
      }
    })
    ...
    expect(wrapper.text()).toContain('admin.accounts.usageWindow.claude|63|2026-03-01T08:00:00Z')
  })
