...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	authService := service.ProvideAuthService(client, userRepository, invitationCodeLookupRepository, refreshTokenCache, configConfig, settingService, emailService, turnstileService, emailQueueService, promoService, subscriptionService, subscriptionProductAdminService, affiliateService)
	userService := service.NewUserService(userRepository, apiKeyAuthCacheInvalidator, billingCache)
	redeemCodeRepository := repository.NewRedeemCodeRepository(client)
	redeemCache := repository.NewRedeemCache(redisClient)
	redeemService := service.ProvideRedeemService(redeemCodeRepository, userRepository, affiliateService, subscriptionService, redeemCache, billingCacheService, client, apiKeyAuthCacheInvalidator, subscriptionProductAdminService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, affiliateHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminSubscriptionProductHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler)
