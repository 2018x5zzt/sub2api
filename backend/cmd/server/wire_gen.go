...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	apiKeyService := service.ProvideAPIKeyService(apiKeyRepository, userRepository, groupRepository, userSubscriptionRepository, userGroupRateRepository, apiKeyCache, configConfig, subscriptionProductService)
	apiKeyAuthCacheInvalidator := service.ProvideAPIKeyAuthCacheInvalidator(apiKeyService)
	promoService := service.NewPromoService(promoCodeRepository, userRepository, billingCacheService, client, apiKeyAuthCacheInvalidator)
	subscriptionService := service.NewSubscriptionService(groupRepository, userSubscriptionRepository, billingCacheService, client, configConfig)
	subscriptionProductAdminService := service.NewSubscriptionProductAdminService(client)
	...
	authService := service.ProvideAuthService(client, userRepository, invitationCodeLookupRepository, refreshTokenCache, configConfig, settingService, emailService, turnstileService, emailQueueService, promoService, subscriptionService, subscriptionProductAdminService, inviteService)
	userService := service.NewUserService(userRepository, apiKeyAuthCacheInvalidator, billingCache)
	redeemCodeRepository := repository.NewRedeemCodeRepository(client)
	redeemCache := repository.NewRedeemCache(redisClient)
	redeemService := service.ProvideRedeemService(redeemCodeRepository, userRepository, inviteService, subscriptionService, redeemCache, billingCacheService, client, apiKeyAuthCacheInvalidator, subscriptionProductAdminService)
	...
	authHandler := handler.NewAuthHandler(configConfig, authService, userService, settingService, promoService, redeemService, inviteService, totpService)
	...
	subscriptionProductHandler := handler.ProvideSubscriptionProductHandler(subscriptionProductService)
	...
	inviteRewardAdminRepository := repository.ProvideInviteRewardAdminRepository(client)
	inviteRelationshipEventAdminRepository := repository.ProvideInviteRelationshipEventAdminRepository(client)
	...
	adminService := service.ProvideAdminService(userRepository, groupRepository, accountRepository, soraAccountRepository, proxyRepository, apiKeyRepository, redeemCodeRepository, inviteAdminQueryRepository, inviteRewardAdminRepository, inviteRelationshipEventAdminRepository, inviteAdminActionRepository, inviteQualifyingRechargeRepository, userGroupRateRepository, billingCacheService, proxyExitInfoProber, proxyLatencyCache, apiKeyAuthCacheInvalidator, client, settingService, subscriptionService, userSubscriptionRepository, privacyClientFactory, subscriptionProductService, subscriptionProductAdminService)
	...
	adminSubscriptionProductHandler := admin.ProvideSubscriptionProductHandler(subscriptionProductAdminService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminInviteHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminSubscriptionProductHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, inviteHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, subscriptionProductHandler, announcementHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, soraGatewayHandler, soraClientHandler, handlerSettingHandler, totpHandler, idempotencyCoordinator, idempotencyCleanupService)
	jwtAuthMiddleware := middleware.NewJWTAuthMiddleware(authService, userService)
	adminAuthMiddleware := middleware.NewAdminAuthMiddleware(authService, userService, settingService)
	apiKeyAuthMiddleware := middleware.ProvideAPIKeyAuthMiddleware(apiKeyService, subscriptionService, configConfig, subscriptionProductService)
	...
	groupHealthSnapshotRepository := repository.NewGroupHealthSnapshotRepository(client, db)
	groupHealthHistoryService := service.ProvideGroupHealthHistoryService(groupRepository, groupHealthSnapshotRepository)
	...
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, soraMediaCleanupService, schedulerSnapshotService, groupHealthHistoryService, tokenRefreshService, accountExpiryService, subscriptionExpiryService, usageCleanupService, idempotencyCleanupService, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, openAIGatewayService, scheduledTestRunnerService, backupService)
