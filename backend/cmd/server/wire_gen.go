...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	subscriptionProductRepository := repository.NewSubscriptionProductRepository(client, db)
	subscriptionProductService := service.NewSubscriptionProductService(subscriptionProductRepository)
	...
	authService.SetDefaultProductSubscriptionAssigner(subscriptionProductAdminService)
	userService := service.NewUserService(userRepository, apiKeyAuthCacheInvalidator, billingCache)
	redeemCodeRepository := repository.NewRedeemCodeRepository(client)
	redeemCache := repository.NewRedeemCache(redisClient)
	redeemService := service.NewRedeemService(redeemCodeRepository, userRepository, inviteService, subscriptionService, redeemCache, billingCacheService, client, apiKeyAuthCacheInvalidator, subscriptionProductAdminService)
	...
	apiKeyHandler := handler.NewAPIKeyHandler(apiKeyService, accountRepository)
	...
	apiKeyHandler.SetBillingService(billingService)
	...
	apiKeyHandler.SetPricingResolver(modelPricingResolver)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminInviteHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler)
	...
	apiKeyAuthMiddleware := middleware.NewAPIKeyAuthMiddleware(apiKeyService, subscriptionService, configConfig, subscriptionProductService)
