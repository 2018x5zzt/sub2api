...
func (r *oauthPendingFlowPromoRepoStub) ListAllUsagesByPromoCode(context.Context, int64) ([]service.PromoCodeUsage, error) {
	return nil, nil
}
...
func (r *oauthPendingFlowPromoRepoStub) Update(_ context.Context, promoCode *service.PromoCode) error {
	if promoCode != nil {
		clone := *promoCode
		r.promo = &clone
	}
