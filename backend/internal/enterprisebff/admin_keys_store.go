...
func mapAPIKeyEntity(m *dbent.APIKey) service.APIKey {
	...
	if m.Edges.User != nil {
		out.User = &service.User{
			...
			SoraStorageQuotaBytes: m.Edges.User.SoraStorageQuotaBytes,
			SoraStorageUsedBytes:  m.Edges.User.SoraStorageUsedBytes,
	...
	if m.Edges.Group != nil {
		out.Group = &service.Group{
			...
			SoraImagePrice360:               m.Edges.Group.SoraImagePrice360,
			SoraImagePrice540:               m.Edges.Group.SoraImagePrice540,
			SoraVideoPricePerRequest:        m.Edges.Group.SoraVideoPricePerRequest,
			SoraVideoPricePerRequestHD:      m.Edges.Group.SoraVideoPricePerRequestHd,
			SoraStorageQuotaBytes:           m.Edges.Group.SoraStorageQuotaBytes,
