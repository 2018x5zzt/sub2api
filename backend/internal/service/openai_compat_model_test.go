...
func TestNormalizeOpenAICompatRequestedModel(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "gpt 5.5 compact alias strips xhigh", input: "gpt5.5-xhigh", want: "gpt-5.5"},
...
func TestApplyOpenAICompatModelNormalization(t *testing.T) {
	...
	t.Run("derives xhigh from gpt 5.5 compact alias suffix", func(t *testing.T) {
		req := &apicompat.AnthropicRequest{Model: "gpt5.5-xhigh"}
...
func TestForwardAsAnthropic_MissingTerminalBeforeOutputReturnsFailoverAndOps(t *testing.T) {
	...
	require.Contains(t, string(failoverErr.ResponseBody), "Upstream stream ended before a terminal event")
