...
func TestDuplicateAccountCopiesConfigurationAndResetsRuntimeState(t *testing.T) {
	...
	source := &Account{
		...
		AccountGroups: []AccountGroup{
			{GroupID: 7, Priority: 50, BillingMultiplier: 1.35},
			{GroupID: 3, Priority: 7, BillingMultiplier: 0.75},
		},
	...
	require.Equal(t, []AccountGroup{
		{AccountID: duplicate.ID, GroupID: 7, Priority: 50, BillingMultiplier: 1.35},
		{AccountID: duplicate.ID, GroupID: 3, Priority: 7, BillingMultiplier: 0.75},
