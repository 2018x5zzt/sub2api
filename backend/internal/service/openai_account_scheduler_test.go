...
func TestOpenAIGatewayService_SelectAccountWithScheduler_NormalizesCodexSparkAliasForModelSupport(t *testing.T) {
	ctx := context.Background()
	groupID := int64(10103)
	account := Account{
		ID:          33001,
...
func TestOpenAIGatewayService_SelectAccountWithSchedulerForImages_RequiresNativeCapability(t *testing.T) {
	ctx := context.Background()
	groupID := int64(101031)
