...
func TestDuplicateGroupCopiesConfigurationDeeplyAndResetsRuntimeState(t *testing.T) {
	...
	source := &Group{
		...
		BalanceFallbackGroupID:          groupDuplicateTestPointer(int64(9)),
	...
	require.Equal(t, source.BalanceFallbackGroupID, duplicate.BalanceFallbackGroupID)
	require.NotSame(t, source.BalanceFallbackGroupID, duplicate.BalanceFallbackGroupID)
	...
	*duplicate.BalanceFallbackGroupID = 999
	...
	require.Equal(t, int64(9), *source.BalanceFallbackGroupID)
}
