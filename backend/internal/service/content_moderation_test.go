...
func (r *contentModerationTestUserRepo) GetByInviteCode(ctx context.Context, code string) (*User, error) {
	return nil, ErrUserNotFound
}

func (r *contentModerationTestUserRepo) ExistsByInviteCode(ctx context.Context, code string) (bool, error) {
	return false, nil
}

func (r *contentModerationTestUserRepo) CountInviteesByInviter(ctx context.Context, inviterID int64) (int64, error) {
	return 0, nil
}
...
func (r *contentModerationTestUserRepo) UpdateInviterBinding(ctx context.Context, inviteeUserID int64, inviterUserID *int64) error {
	return nil
}
