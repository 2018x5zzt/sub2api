...
const apiKeyAuthSnapshotVersion = 13 // v13: includes API Key name, allowed_groups, custom models_list_config, and exclusive group authorization fields
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			PricingMode:                     apiKey.Group.PricingMode,
			DefaultBudgetMultiplier:         apiKey.Group.DefaultBudgetMultiplier,
			...
			BalanceFallbackGroupID:          apiKey.Group.BalanceFallbackGroupID,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			PricingMode:                     snapshot.Group.PricingMode,
			DefaultBudgetMultiplier:         snapshot.Group.DefaultBudgetMultiplier,
			...
			BalanceFallbackGroupID:          snapshot.Group.BalanceFallbackGroupID,
