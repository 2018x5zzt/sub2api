-- Restore the legacy xlabapi shared subscription-product runtime tables.
-- These tables are intentionally additive and idempotent. Existing production
-- data is preserved; fresh installs get the schema needed by the restored
-- product-subscription billing path.
