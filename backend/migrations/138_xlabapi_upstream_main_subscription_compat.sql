-- xlabapi shared subscription product compatibility on top of upstream/main.
-- Keep this migration additive and idempotent: existing upstream subscription_plans
-- are not rewritten, and xlabapi product subscriptions remain available.
