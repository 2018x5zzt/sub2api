...
type PaymentOrder struct {
	...
	// SubscriptionProductID holds the value of the "subscription_product_id" field.
	SubscriptionProductID *int64 `json:"subscription_product_id,omitempty"`
...
func (*PaymentOrder) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case paymentorder.FieldID, paymentorder.FieldUserID, paymentorder.FieldPlanID, paymentorder.FieldSubscriptionGroupID, paymentorder.FieldSubscriptionProductID, paymentorder.FieldSubscriptionDays:
...
func (_m *PaymentOrder) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case paymentorder.FieldSubscriptionProductID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field subscription_product_id", values[i])
			} else if value.Valid {
				_m.SubscriptionProductID = new(int64)
				*_m.SubscriptionProductID = value.Int64
			}
...
func (_m *PaymentOrder) String() string {
	...
	builder.WriteString(", ")
	if v := _m.SubscriptionProductID; v != nil {
		builder.WriteString("subscription_product_id=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
