...
func init() {
	...
	groupDescPricingMode := groupFields[3].Descriptor()
	...
	userDescSoraStorageQuotaBytes := userFields[14].Descriptor()
	...
	userDescSoraStorageUsedBytes := userFields[15].Descriptor()
