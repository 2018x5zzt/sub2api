...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldID, user.FieldConcurrency, user.FieldInvitedByUserID, user.FieldSoraStorageQuotaBytes, user.FieldSoraStorageUsedBytes:
		...
		case user.FieldCreatedAt, user.FieldUpdatedAt, user.FieldDeletedAt, user.FieldInviteBoundAt, user.FieldTotpEnabledAt:
