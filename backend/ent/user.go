...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldBalance, user.FieldFrozenBalance, user.FieldBalanceNotifyThreshold, user.FieldTotalRecharged, user.FieldSubscriptionBalanceFallbackLimitUsd, user.FieldSubscriptionBalanceFallbackUsedUsd:
			values[i] = new(sql.NullFloat64)
		case user.FieldID, user.FieldConcurrency, user.FieldRpmLimit, user.FieldSubscriptionBalanceFallbackGroupID:
