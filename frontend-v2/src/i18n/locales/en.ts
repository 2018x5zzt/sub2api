export default {
  ...
  v2Common: {
    ...
    autoPauseExpired: 'Auto-pause when expired',
    schedulable: 'Schedulable',
    schedulableHint: 'eligible for routing',
    visibleAdminsOnly: 'Visible only to admins',
    noProxyHint: 'Blank = no proxy',
    higherPreferredHint: 'Higher = preferred',
    blankUseGroupHint: 'Blank = use group',
    commaSeparatedGroupIds: 'Comma-separated, e.g. 1,2,5',
    accountExpiryHint: 'Account will reject requests after this point',
    maskedSecretHint: 'Existing secrets show as masked placeholders. Replace them with a fresh value to rotate.',
    suggestedCredentialShape: 'Suggested shape for {platform}/{type}; replace placeholders with real values.',
    platformCredentialJson: 'Provide platform-specific keys as JSON.',
    ...
    noLimits: 'No limits',
    noUsageLimits: 'No usage limits configured',
    free: 'Free',
    day: 'Day',
    week: 'Week',
    month: 'Month',
    ...
    daysDate: '{days}d · {date}',
    currentExpiry: 'current expiry',
    noExpirationSymbol: '∞',
    stream: 'Stream',
    sync: 'Sync',
    requestType: 'Request type',
    copiedCount: 'Copied {count} codes',
    generatedCount: 'Generated {count} codes',
    deletedCount: 'Deleted {count} codes',
    deleteSelected: 'Delete selected ({count})',
    deleteCountConfirm: 'Delete {count} codes?',
    valuePositive: 'Value must be greater than 0',
    countRange: 'Count must be between 1 and 1000',
    subscriptionGroupRequired: 'Group ID is required for subscription codes',
    fieldRequired: '{field} is required',
    invalidJson: 'Credentials must be valid JSON: {message}',
    notLoaded: 'Not loaded',
    noneSelected: 'No item selected',
    nonZeroDays: 'Days must be non-zero',
    negativeShortensHint: 'Negative values shorten; e.g. 30 to add a month',
    unlimitedValidityHint: 'Leave blank or 0 = unlimited',
    editDeferred: 'Edit is not yet migrated to v2',
    configured: 'configured',
    notSet: 'not set',
    leaveBlankKeepExisting: 'Leave blank to keep existing',
    enterSecret: 'Enter secret',
    show: 'show',
    hide: 'hide',
    testConnection: 'Test connection',
    connected: 'Connected',
    testFailed: '{target} test failed'
  },

  v2Admin: {
    usage: {
      title: 'Usage',
      description: 'All requests across users, with searchable logs.'
    },
    subscriptions: {
      title: 'Subscriptions',
      description: 'Assign group subscriptions to users, then extend or revoke them as needed.',
      assign: 'Assign',
      extend: 'Extend',
      revoke: 'Revoke',
      assignTitle: 'Assign subscription',
      extendTitle: 'Extend subscription #{id}',
      searchPlaceholder: 'User email / name...',
      revokeConfirm: 'Revoke subscription #{id} ({group})?'
    },
    accounts: {
      description: 'Manage upstream provider accounts and platform-specific credentials.',
    ...
    promoCodes: {
      ...
      editTitle: 'Edit {code}',
      usagesTitle: 'Usages — {code}',
      deleteConfirm: 'Delete promo code "{code}"?',
      usageTitle: 'Usages'
    },
    redeemCodes: {
      title: 'Redeem Codes',
      ...
      generatedCount: '{count} codes generated',
      deleteConfirm: 'Delete this code?',
      codeCount: '{count} codes',
      copyAll: 'Copy all'
    },
    placeholder: {
      message: 'This admin section is not yet migrated to v2. See {file}.'
    }
  },
  ...
  landing: {
    ...
    operations: {
      ...
      features: {
        routing: {
          ...
          description: 'Automatically choose the best upstream by latency, cost, and availability.'
        },
        unified: {
          title: 'Unified API Layer',
          description: 'Use one OpenAI-compatible interface across every supported model.'
        },
        reliability: {
          title: 'Production Reliability',
          description: 'Multi-account failover, rate-limit handling, and operational visibility.'
        }
      },
      metrics: {
    ...
    cta: {
      ...
      titleLine1: 'Ready to see how',
      titleEmphasis1: 'we turn',
      titleEmphasis2: 'models',
      titleLine2: 'into',
  ...
  keys: {
    ...
    budgetMultiplierHint: 'Required for dynamic groups. Range {min}x - {max}x. Default for this group is {default}x.',
    budgetMultiplierRequired: 'Please set a budget multiplier',
    statusLabel: 'Status',
  ...
  admin: {
    ...
    settings: {
      ...
      site: {
        ...
        docUrlHint: 'Link to your documentation site. Leave empty to use the default Xlabapi guide.',
        siteLogo: 'Site Logo',
