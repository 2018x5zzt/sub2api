/**
 * Console v4 — Plato (Xlabapi dark + warm orange).
 * Adapted from the frontend-v2 console prototype.
    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          ...
          <span style={{ fontSize: 14.5, fontWeight: 600, letterSpacing: '-0.01em' }}>XLABAPI</span>
