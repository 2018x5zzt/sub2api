      ...
      <Card className="p-0 overflow-hidden">
        {loading && catalogs.length === 0 ? (
          ...
          <div className="overflow-x-auto">
            ...
            >
              <div>{t('v2Common.group')}</div>
              <div>{t('v2Common.model')}</div>
              <div>{t('v2Common.platform')}</div>
              <div className="text-right">{t('v2Common.inputMtok')}</div>
              <div className="text-right">{t('v2Common.outputMtok')}</div>
            </div>
