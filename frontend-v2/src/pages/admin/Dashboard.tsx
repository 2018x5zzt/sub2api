...
export default function AdminDashboard() {
  ...
  if (isLoading || !data) {
    return (
      <>
        <PageHeader title={t('dashboard.title')} description="Admin overview" />
    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <Stat
          ...
          sub={`+${data.today_new_users} today · ${data.active_users} active`}
        ...
        <Stat
          ...
          sub={`${data.normal_accounts} ok · ${data.error_accounts} err · ${data.ratelimit_accounts} rate`}
