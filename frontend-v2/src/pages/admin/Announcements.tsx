...
export default function AdminAnnouncementsPage() {
    ...
    <form onSubmit={onSubmit} id="announcement-form" className="space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Markdown / HTML accepted"
        />
      </div>
      <div className="grid grid-cols-2 gap-3">
        ...
        <div>
          <label className="input-label">Notify mode</label>
          <select
          ...
          <p className="text-xs text-ink-3 mt-1">
            <span className="font-mono">popup</span> shows on next login as a modal;{' '}
            <span className="font-mono">silent</span> only appears in the inbox.
          </p>
        </div>
      </div>
      <div className="grid grid-cols-2 gap-3">
      ...
      <p className="text-xs text-ink-3">
        Targeting (subscription/balance conditions) defaults to all users in this view — fine-grained targeting builder is deferred to Phase 3.
      </p>
    </form>
  )
  ...
  return (
    <>
      <PageHeader
        title="Announcements"
        description="Author broadcast messages with optional schedule and login popup."
        actions={
