...
export default function AdminUsagePage() {
  ...
  return (
    <>
      <PageHeader title={t('v2Admin.usage.title')} description={t('v2Admin.usage.description') as string} />
      ...
      <Card className="p-4 mb-4">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 mb-3">
          ...
          <Input
            name="api_key_id"
            label={t('v2Common.apiKeyId') as string}
            placeholder="—"
            value={apiKeyIdInput}
          ...
          <Input
            name="model"
            label={t('v2Common.model') as string}
          ...
          <Input
            name="start_date"
            type="date"
            label={t('v2Common.from') as string}
            value={startDate}
              ...
              {(data?.items ?? []).map((log) => {
                ...
                return (
                  <TR key={log.id}>
                    ...
                    <TD>
                      {log.stream ? (
                        <Badge tone="accent">{t('usage.stream')}</Badge>
                      ) : (
